        ...
        <div className="legal-page">
            ...
            <div className="container">
                <div className="legal-content">
                    ...
                    <section>
                        <h2>7. PillScan Data Deletion Guide</h2>
                        <p>
                            Below is a guide on how to delete data from your account connected through the PillScan app.
                        </p>

                        <h3>7.1 How to Delete Data</h3>
                        <p>To delete data from your PillScan account, follow these steps:</p>
                        <ol>
                            <li>Log in to the app.</li>
                            <li>Tap the menu in the top-left corner.</li>
                            <li>Select your 'Account Email' at the top, then tap 'Delete Account'.</li>
                        </ol>

                        <h3>7.2 Scope of Data Deletion</h3>
                        <p>The following data will be deleted through the above process:</p>
                        <ul>
                            <li>Email address</li>
                            <li>UID (Unique Identifier) generated per account</li>
                        </ul>

                        <h3>7.3 Deleting In-App Data</h3>
                        <p>
                            To delete data within the PillScan app, use the 'Delete Account' option in the app settings.
                        </p>

                        <h3>7.4 Important Notes</h3>
                        <ul>
                            <li>After data deletion, you will be logged in with a new account assigned a new UID.</li>
                            <li>Deletion is not available while you have an active premium subscription. You can delete your account after the subscription expires.</li>
                        </ul>
